  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center justify-between bg-blue-700 dark:bg-gray-800 text-white px-4 py-3 shadow-md fixed top-0 left-0 right-0 z-50">
        <div className="text-xl font-bold">NEXINDI ADMIN</div>
        <button
...
>
        ...
        <div className="hidden md:flex items-center justify-between px-6 py-4 border-b border-blue-600">
          <div className="text-2xl font-bold">NEXINDI ADMIN</div>
        </div>
      ...
      <div className="border-t border-blue-600 px-6 py-4">
        ...
        className="w-full flex items-center gap-2 text-white hover:text-white hover:bg-blue-700 px-3 py-2 rounded-lg transition">
          <LogOut size={18} />
          Logout
        </button>
